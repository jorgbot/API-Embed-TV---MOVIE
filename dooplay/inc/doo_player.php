...
class DooPlayer{
     ...
     * @version 1.0
     */
    public static function viewer($post, $type, $players, $trailer, $size, $views, $ads = false, $image = false, $movie_title = "", $imdb_tmdb_id = "", $tv = false, $season = 0, $episode = 0){
		// Set Ajax Player
        ...
        if(1==1){
			...
			if($ajax_player == true){
				...
				$html .="<div id='source-player-vs' class='source-box'>";
                $html .="<div class='pframe'><if"."rame class='metaframe rptss' src='{$fsapi_link}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame></div>";
                $html .="</div>";
			...
			global $wpdb;
            $fsapi_get_id = $wpdb->get_results("SELECT meta_value FROM wp_postmeta WHERE post_id = '$post' AND meta_key = 'ids'");
            $fsapi_id =  $fsapi_get_id[0]->meta_value;

            $fsapi_get_idtmdb = $wpdb->get_results("SELECT meta_value FROM wp_postmeta WHERE post_id = '$post' AND meta_key = 'idtmdb'");
            $fsapi_idtmdb =  $fsapi_get_idtmdb[0]->meta_value;

            if($tv) {
                //API Tv Series Integration
                $fsapi_linken01 = 'https://vidsrc.me/embed/'.$fsapi_id.'/'.$season.'-'.$episode;
                $fsapi_linken02 = 'https://ytsmovie.net/se_player.php?video_id='.$fsapi_id.'&tmdb=1&s='.$season.'&e='.$episode;
                $fsapi_linken03 = 'https://autoembed.to/tv/imdb/'.$fsapi_id.'-'.$season.'-'.$episode;
                $fsapi_linkes01 = 'https://play.repelishd.cx/embeds/tmdb/'.$fsapi_id.'/'.$season.'/'.$episode;
                $fsapi_linkes02 = 'https://embedsito.net/video/'.$fsapi_id.'-'.$season.'x'.$episode;
                
            } else {
                //API Movies Integration
                $fsapi_linken01 = 'https://vidsrc.me/embed/'.$fsapi_id;
                $fsapi_linken02 = 'https://ytsmovie.net/se_player.php?video_id='.$fsapi_id;
                $fsapi_linken03 = 'https://autoembed.to/movie/imdb/'.$fsapi_id;
                $fsapi_linkes01 = 'https://embedsito.net/video/'.$fsapi_id;
                $fsapi_linkes02 = 'https://play.repelishd.cx/embeds/tmdb/'.$fsapi_idtmdb;
            }
			
            if($tv) {
                $html .='<li id="player-option-1" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linken01.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">01-English</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/en.png"></span>
                            <span class="loader"></span>
                        </li>';
                $html .='<li id="player-option-1" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linken02.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">02-English</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/en.png"></span>
                            <span class="loader"></span>
                        </li>';
                $html .='<li id="player-option-1" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linken03.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">03-English</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/en.png"></span>
                            <span class="loader"></span>
                        </li>';
                $html .='<li id="player-option-1" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linkes01.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">01-Spanish</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/es.png"></span>
                            <span class="loader"></span>
                        </li>';
                $html .='<li id="player-option-1" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linkes02.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">02-Spanish</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/es.png"></span>
                            <span class="loader"></span>
                        </li>';
			} else {
				  $html .='<li id="player-option-'.$num.'" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linken01.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">01-English</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/en.png"></span>
                            <span class="loader"></span>
                        </li>';
				  $html .='<li id="player-option-'.$num.'" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linken02.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">02-English</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/en.png"></span>
                            <span class="loader"></span>
                        </li>';
				  $html .='<li id="player-option-'.$num.'" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linken03.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">03-English</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/en.png"></span>
                            <span class="loader"></span>
                        </li>';
                  $html .='<li id="player-option-'.$num.'" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linkes01.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">01-Spanish</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/es.png"></span>
                            <span class="loader"></span>
                        </li>';
                  $html .='<li id="player-option-'.$num.'" class="dooplay_player_option vs" data-post="vs" data-type='.$type.' data-nume="vs" data-vs="'.$fsapi_linkes02.'">
                            <i class="fas fa-play-circle"></i>
                            <span class="server">02-Spanish</span>
                            <span class="flag"><img src="'.DOO_URI.'/assets/img/flags/es.png"></span>
                            <span class="loader"></span>
