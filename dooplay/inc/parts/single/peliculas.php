...
//FlixTv
$flixtv_url_watch='https://orbmatchingenough.com/cvb62qq4?key=9af6cf71d6eac16c6b6adbaab55342ba';
$flixtv_url_torrent='https://orbmatchingenough.com/cvb62qq4?key=9af6cf71d6eac16c6b6adbaab55342ba';
$flixtv_url_subtitles='https://orbmatchingenough.com/cvb62qq4?key=9af6cf71d6eac16c6b6adbaab55342ba';
// Dynamic Background
...
<div id="single" class="dtsingle" itemscope itemtype="http://schema.org/Movie">
    ...
    <?php if(have_posts()) :while (have_posts()) : the_post(); ?>
        <div class="content <?php echo $sidebar; ?>">
            ...
            <?php DooPlayer::viewer($post->ID, 'movie', $player, $trailer, $player_wht, $tviews, $player_ads, $dynamicbg, get_the_title(), $imdb_id , 0,0,0); ?>
            <!-- Head movie Info -->
            <div class="sheader">
                <div class="poster">
                    ...
                    <div class="links_table">
                        <div class="fix-table">
                            <table>
                                ...
                                <tr id="link-1">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $flixtv_url_watch.$imdb_id ?>"> <a href="<?php echo $flixtv_url_watch?>" target="_blank">Watch Online: <?php the_title(); ?></a></td>
                                    <td>Online</td>
                                    <td>1080p</td>
                                </tr>

                                <tr id="link-2">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $flixtv_url_torrent.$imdb_id ?>"> <a href="<?php echo $flixtv_url_torrent?>" target="_blank">Download Torrent: <?php the_title(); ?></a></td>
                                    <td>Torrent</td>
                                    <td>1080p</td>
                                </tr>

                                <tr id="link-3">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $flixtv_url_subtitles.$imdb_id ?>"> <a href="<?php echo $flixtv_url_subtitles?>" target="_blank">Download Subtitles: <?php the_title(); ?></a></td>
                                    <td>Subtitles</td>
                                    <td>1080p</td>
                                </tr>
